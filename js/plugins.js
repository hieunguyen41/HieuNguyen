...
function blSetPage() {
  var n = $(window).width() - 300,
    ...
    o = $(".border-l-line"),
    s = $(".border-r-line");
  e.css({ width: n }).css({ WebkitTransition: "none", transition: "none" }),
    t.css({ width: n }).css({ WebkitTransition: "none", transition: "none" }),
    o.css({ height: i }).css({ WebkitTransition: "none", transition: "none" }),
    s.css({ height: i }).css({ WebkitTransition: "none", transition: "none" });
}
$(function () {
  var o = $(".border-t-line"),
    s = $(".border-b-line"),
  ...
  $(window).bind("load", function () {
    ...
    $(window).bind("resize", function () {
      ...
      $(".hero-bg").css({ height: n }),
        o.css({ WebkitTransition: "none", transition: "none" }),
        s.css({ WebkitTransition: "none", transition: "none" }),
        r.css({ WebkitTransition: "none", transition: "none" }),
        h.css({ WebkitTransition: "none", transition: "none" }),
        blSet();
    });
});
